...
//	public WebElement viewButton;
	...
	public void verifyBillingAddressFunctionallity() throws InterruptedException {
		...
		billingCountrySearchBox.sendKeys(Base.getProperty("billingCountry"));
		Thread.sleep(2000);
		billingCountrySearchBox.sendKeys(Keys.RETURN);
		...
		billingStateSearchBox.sendKeys(Base.getProperty("billingState"));
		Thread.sleep(2000);
	...
	public void verifyAdditionalInfoFunctionality() {
